...
curl -X POST -H "Content-Type: application/json" -d "{\"Server\": {\"Id\":\"srv_"$MODEL"\",\"URL\":\"http://127.0.0.1:"$BACKEND_PORT"\"}}" "http://192.168.99.100:8182/v2/backends/bck_$MODEL/servers"  | jq .
