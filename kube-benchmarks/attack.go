...
func attackCmd() command {
	...
	opts := &attackOpts{
        ...
        fs.StringVar(&opts.dataset, "volumeReferences", 150, "How many random pictures shall we sumbit ?")
        fs.StringVar(&opts.dataset, "dataset", "./dataset", "Dataset local folder")
        fs.StringVar(&opts.jsonPayload, "jsonPayload", "stdin", "Json Payload")
        fs.StringVar(&opts.imageFile, "file", "stdin", "Image file")
