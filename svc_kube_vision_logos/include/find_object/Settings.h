...
class FINDOBJECT_EXP Settings
{
	...
	PARAMETER(Listener, host, QString, "0.0.0.0", "Hostname (default 0.0.0.0).");
	PARAMETER(Listener, port, int, 18081, "Port (default 18081).");
	PARAMETER(Listener, minThreads, int, 1, "minThreads (default 1).");
	PARAMETER(Listener, maxThreads, int, 100, "maxThreads (default 100).");
	PARAMETER(Listener, cleanupInterval, int, 100, "cleanupInterval (default 100).");
	PARAMETER(Listener, readTimeout, int, 2500, "readTimeout (default 2500).");
	PARAMETER(Listener, maxRequestSize, int, 16000, "maxRequestSize (default 16000).");
	PARAMETER(Listener, 8maxMultiPartSize, int, 10000000, "maxMultiPartSize (default 10000000).");
